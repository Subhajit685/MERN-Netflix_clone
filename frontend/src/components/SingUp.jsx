        ...
        <div className='h-screen w-full hero-bg'>
            ...
            <div className='flex justify-center items-center mt-20 mx-3'>
                ...
                <div className='w-full max-w-md p-8 space-y-6 bg-black/60 rounded-lg shadow-md'>
                    ...
                    <h1 className='text-center text-white text-2xl fornt-bold md-4'>Sing Up</h1>
                    ...
                    <form className='space-y-4' onSubmit={hendelSubmit}>
                        ...
                        <div>
                            ...
                            <input type="text" id='name' name='name' className='w-full px-3 py-2 border broder-gray-700 rounded-md bg-transparent text-white focus:outline-none focus:ring'
                                placeholder='jhondeo' value={name} onChange={(e)=> setname(e.target.value)} />
                        </div>
                    ...
                    <div className='text-center text-gray-400'>
                        Already have a account?{" "}<Link to={"/login"} className='text-red-500 hover:underline'>Sing In</Link>
                    </div>
